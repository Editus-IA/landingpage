  ...
  <div class="min-h-screen bg-editus-950 flex flex-col items-center justify-center px-6 py-24">
    <div class="max-w-md w-full text-center">
      <div class="w-16 h-16 bg-editus-800/60 border border-editus-700/40 rounded-2xl flex items-center justify-center mx-auto mb-8">
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" class="text-editus-400">
          <circle cx="14" cy="14" r="11" stroke="currentColor" stroke-width="1.8"/>
          <path d="M14 8v7M14 18.5v1" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>
        </svg>
      </div>
      ...
      <div class="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <button @click="handleError" class="btn-ghost">
          Tentar novamente
        </button>
      </div>
    </div>
